...
public class UcloudWatchPlugin implements CramsConsumerPlugin {
    ...
    public Map<String, Object> excute(Map<String, Object> rrdMap, String dataTag)
        ...
        rrdMap = excuteCramsPlugins(rrdMap, dataTag);
        ...
        // parse demension list for ucloud watch
        List<UcloudWatchDemension> demensionList = parseUWatchDemensionList(rrdMap);
        ...
        String ucloudWatchRequestParmaeter = createPutMatricRequest(namespace,
                owner, demensionList, rrdMap);
        if(ucloudWatchRequestParmaeter == null || ucloudWatchRequestParmaeter.isEmpty()) {
            logger.error("noting to send, original data:" + rrdMap);
            return null;
        }
        //send metric data
     ...
     * @throws CramsPluginException 
     */
    private List<UcloudWatchDemension> parseUWatchDemensionList(Map<String, Object> rrdMap) throws CramsPluginException {
    ...
    private Map<String, Object> excuteCramsPlugins(Map<String, Object> rrdMap, String dataTag) throws CramsPluginException {
    ...
    private String createPutMatricRequest(String namespace, String owner,
            List<UcloudWatchDemension> demensionList, Map<String, Object> rrdMap) throws CramsPluginException {
        // create metric data
        ...
        if (ucloudWatchMetricData == null || ucloudWatchMetricData.isEmpty()) {
            throw new CramsPluginException("failed to parsing matric data," + rrdMap);
        }
